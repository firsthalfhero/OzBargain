...
from ozb_deal_filter.components.deal_parser import PriceExtractor, DealValidator, DealParser
...
class TestPriceExtractor:
    ...
    def test_extract_prices_no_prices(self):
        ...
        current, original = extractor.extract_prices("Great deal with no specific price")
    ...
    def test_extract_discount_percentage_calculated(self):
        ...
        discount = extractor.extract_discount_percentage("", current_price=50.0, original_price=100.0)
    ...
    def test_extract_discount_percentage_invalid_calculation(self):
        ...
        discount = extractor.extract_discount_percentage("", current_price=150.0, original_price=100.0)
    ...
    def test_extract_discount_percentage_none(self):
        ...
        discount = extractor.extract_discount_percentage("Great deal with no discount mentioned")
    ...
    def test_extract_urgency_indicators_multiple(self):
        ...
        indicators = extractor.extract_urgency_indicators("Limited time flash sale! Hurry while stocks last!")
    ...
    def test_extract_urgency_indicators_none(self):
        ...
        indicators = extractor.extract_urgency_indicators("Regular deal with no urgency")
...
class TestDealParser:
    ...
    def test_validate_deal_calls_validator(self):
        ...
        with patch.object(parser.validator, 'validate_deal', return_value=True) as mock_validate:
...
class TestIntegration:
    ...
    def test_price_extraction_integration(self):
        ...
        assert abs(deal2.discount_percentage - 50.0) < 1.0  # Allow small rounding difference
    ...
    def test_urgency_extraction_integration(self):
        ...
        assert any(keyword in urgency_text for keyword in ['flash', 'limited', 'hurry', 'stocks'])
