...
class TestPromptManager:
    ...
    def test_load_template_missing_required_placeholders(self, temp_prompts_dir, invalid_template):
    ...
    def test_validate_template_file_absolute_path(self, temp_prompts_dir, sample_template):
