...
def run_integration_tests(test_categories: List[str] = None, verbose: bool = False) -> bool:
...
def check_test_environment() -> bool:
    ...
    checks.append(("Python 3.11+", python_ok, f"{python_version.major}.{python_version.minor}"))
    ...
    for test_file in test_files:
        ...
        checks.append((f"Test file: {test_file}", file_exists, "exists" if file_exists else "missing"))
    ...
    for source_file in source_files:
        ...
        file_exists = file_path.exists()
        checks.append((f"Source file: {source_file}", file_exists, "exists" if file_exists else "missing"))
